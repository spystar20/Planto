                ...
                <div className='grid grid-cols-3'>
                    ...
                    <div className=' flex flex-col justify-between gap-y-20 col-span-2'>
                        <div className='flex flex-col gap-4'>
                            <h2 className='font-semibold text-9xl'>Breath Natural</h2>
                            <p className='text-xl font-light  text-wrap'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
...
<div className='flex flex-col items-center justify-center my-20 gap-12'>
    <div className="relative inline-block px-6 py-3 rounded-2xl mb-23">
  {/* Top Left */}
...
<div className='flex flex-col gap-18 w-full'>
     <div  className='relative h-[380px] my-12 w-full rounded-[120px] bg-white/5 backdrop-blur-xl border-2 border-white/10 grid grid-cols-2  px-6'>
<div className='relative '>
    <img className='absolute -top-1/2 left-2 w-5/6 z-10 ' src={Trendy1} alt="" />
</div>
<div className=' p-4  text-white gap-4  flex flex-col items-start justify-center w-full'>

   <h2 className='text-3xl font-medium  '>For Small Decs Ai Plat</h2>
       ...
       <span className='text-3xl font-medium  '>Rs. 599/-</span>
    ...
    <span className='p-2 border-2 rounded-lg border-white/60'><IoBagHandleOutline className='text-2xl'/></span>
                      ...
                      <div  className='relative my-12 h-[380px] w-full rounded-[120px] bg-white/5 backdrop-blur-xl border-2 border-white/10 grid grid-cols-2  px-6'>
                      <div className=' p-4  text-white gap-4  flex flex-col items-start justify-center w-full'>
