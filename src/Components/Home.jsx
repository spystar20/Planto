...
const Home = () => {
    ...
    return (
        <div className='w-full font-inter text-white/80 -mt-26'>
            <div className='min-h-screen bg-center bg-cover p-5 pt-23 md:pt-36' style={{ backgroundImage: `url(${BackgroundImg})` }}>
                {/* herosection */}
                <div className='grid grid-cols-1  md:grid-cols-3'>
                    {/* left-side */}
                    <div className=' flex flex-col justify-between gap-y-20 col-span-2'>
                        <div className='flex flex-col gap-4'>
                            <h2 className='font-semibold text-5xl md:text-6xl lg:text-9xl'>Breath Natural</h2>
...
<div className='flex flex-col items-center justify-center my-20 lg:gap-12'>
  <Heading title='Our Trendy plants'/>
<div className='flex flex-col md:gap-6 lg:gap-18 w-full'>
     <div  className='relative h-[500px] md:h-[380px] lg:my-12 w-full rounded-3xl md:rounded-[120px] bg-white/5 backdrop-blur-xl border-2 border-white/10 grid grid-cols-1 md:grid-cols-2 px-3 md:px-6'>
<div className='relative  '>
    <img className='md:absolute w-[340px] lg:-top-1/2 left-2 lg:w-5/6 z-10 ' src={Trendy1} alt="" />
</div>
<div className='-mt-12 md:mt-0 p-4  text-white gap-2 md:gap-4  flex flex-col items-start justify-center w-full'>
   ...
   <h2 className='text-xl md:text-3xl font-medium  '>For Small Decs Ai Plat</h2>
    ...
    <span className='p-2 border-2 rounded-lg border-white/60'><IoBagHandleOutline className='text-2xl'/></span>
                      ...
                      <div  className='relative h-[530px] md:h-[380px] lg:my-12 w-full rounded-3xl md:rounded-[120px] bg-white/5 backdrop-blur-xl border-2 border-white/10 grid grid-cols-1  md:grid-cols-2 px-3 md:px-6'>
...
<div className='relative order-1 md:order-2'>
    <img className=' md:absolute lg:-top-1/3 left-2 md:w-5/6 z-10 ' src={Trendy2} alt="" />
</div>
